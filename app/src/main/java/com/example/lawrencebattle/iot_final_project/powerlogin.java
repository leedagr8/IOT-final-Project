...
public class powerlogin extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Action Listener
        Login.setOnClickListener(powerlogin.this);
    ...
    private void userLogin(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(powerlogin.this);


        StringRequest stringRequest = new StringRequest( //used to send post method
                Request.Method.POST,
                Constants.URL_LOGIN_POW,
